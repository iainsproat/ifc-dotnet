...
namespace StepParser_UnitTests
{
	...
	public class ExampleData
	{
		...
		public static string simpleStepWithCommentString(){
			return STEPHeader() +
				"#1 = IFCPROJECT('3MD_HkJ6X2EwpfIbCFm0g_', #2, 'Default Project', 'Description of Default Project', $, -22.4 , $, (#20), #7); /* a comment */\r\n" +
				"#2 = IFCOWNERHISTORY(#3, IFCTEXT('foobar'), $, .ADDED., $, .FALSE., *, 1217620436);\r\n" +
				STEPFooter();
		}
		
		public static string simpleStepString(){
			return STEPHeader() +
				"#1 = IFCPROJECT('3MD_HkJ6X2EwpfIbCFm0g_', #2, 'Default Project', 'Description of Default Project', $, -22.4, $, (#20), #7);\r\n" +
				"#2 = IFCOWNERHISTORY(#3, IFCTEXT('foobar'), $, .ADDED., $, .F., *, 1217620436);\r\n" +
				STEPFooter();
		}
		
		public static string STEPHeader(){
			return "ISO-10303-21;\r\n" +
				"HEADER;\r\n" +
		...
		public static string STEPFooter(){
			return "ENDSEC;\r\n" +
				"END-ISO-10303-21;";
		}
		
		public static string AmbiguousNumberString(){
			return STEPHeader() +
				"#1 = IFCEXAMPLE(1E-5);\r\n" +
				STEPFooter();
		}
		
		public static string ObjectNameBeginningWithE(){
			return STEPHeader() +
				"#1 = EXAMPLE('foo');\r\n" +
				STEPFooter();
		}
